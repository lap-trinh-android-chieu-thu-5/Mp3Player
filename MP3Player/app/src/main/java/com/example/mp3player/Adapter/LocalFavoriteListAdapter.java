...
public class LocalFavoriteListAdapter extends RecyclerView.Adapter<LocalFavoriteListAdapter.ViewHolder> {
    ...
    public LocalFavoriteListAdapter(Context context, List<Song> lstSong, boolean isEdit){
    ...
    @Override
    public LocalFavoriteListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.local_song_list_item,parent, false);
        return new LocalFavoriteListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(LocalFavoriteListAdapter.ViewHolder holder, int position) {
