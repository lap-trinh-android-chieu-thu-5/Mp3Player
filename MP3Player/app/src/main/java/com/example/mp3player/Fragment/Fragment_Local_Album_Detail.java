...
public class Fragment_Local_Album_Detail extends Fragment {
    String mAlbumId;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_local_album_detail, container, false);
        return view;
    }
    ...
    public void init(){
        mLstSong = Song.find(Song.class, "album = ?",  String.valueOf(this.mAlbumId));
